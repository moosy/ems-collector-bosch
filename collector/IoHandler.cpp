...
printDescriptive(std::ostream& stream, const EmsValue& value)
{
	...
	{ EmsValue::RaumTemperaturAenderung, "Raumtemperaturänderung" },
	...
	{ EmsValue::BetriebsZeit, "Betriebszeit 2" },
	...
	{ EmsValue::RaumTemperaturAenderung, "K/min" },
